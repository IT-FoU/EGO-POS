...
- [ ] Update the current sale-number validation/issuance logic so valid reserved offline references are accepted safely and cannot collide with cloud-issued references. <!-- Server-side acceptance of reserved offline references is Phase 6B (not changed yet). -->
