...
const adminNavigation = [
  ...
  { href: "/super-admin/businesses", icon: Building2, labelKey: "businesses" },
  { href: "/super-admin/users", icon: Users, labelKey: "users" },
  { href: "/super-admin/subscriptions", icon: CreditCard, labelKey: "subscriptions" },
  { href: "/super-admin/audit-logs", icon: Activity, labelKey: "auditLogs" },
];
      ...
      <aside className="fixed inset-y-0 left-0 hidden w-72 border-r border-border bg-card lg:flex lg:flex-col">
        <div className="border-b border-border p-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-lg font-semibold"><AdminText k="superAdminBrand" /></div>
