...
export const LEGACY_PERMISSION_ENTRIES = [
  ...
  ["pos.cash_session.manage", "Open and close cashier shifts", "pos"],
...
export const PERMISSION_ALIAS_GROUPS: Record<string, string[]> = {
  ...
  "pos.cash_session.manage": ["pos.create", "pos.sell", "pos.cash_session.manage"],
  "pos.cash_session.view": ["dashboard.view", "reports.view", "pos.create", "pos.sell", "pos.cash_session.view"],
