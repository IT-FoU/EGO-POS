...
import { WRITE_PERMISSIONS, type WritePermissionKey } from "@/lib/auth/permissions";
...
export const APPROVAL_REQUESTER_PERMISSION: Record<ApprovalRuleKey, WritePermissionKey> = {
